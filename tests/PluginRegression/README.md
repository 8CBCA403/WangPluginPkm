...
Checks independent move selection, PK8/PB8/PA8 stat alignment conversion, host theme inheritance, semantic colors, and dynamically added controls. A failing assertion exits nonzero.
