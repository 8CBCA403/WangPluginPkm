...
namespace WangPlugin.SortBase
{
    class Gen5_Unova : SortingBase
    {
        ...
        private static readonly Dictionary<Species, int> BWdex = new Dictionary<Species, int>() {
      {Species.Victini, 0},
      {Species.Snivy, 1},
      {Species.Servine, 2},
      {Species.Serperior, 3},
      ...
      {Species.Tornadus, 147},
      {Species.Thundurus, 148},
      {Species.Reshiram, 149},
      {Species.Zekrom, 150},
      {Species.Landorus, 151},
      {Species.Kyurem, 152},
      {Species.Keldeo, 153},
      {Species.Meloetta, 154},
      {Species.Genesect, 155},
    };

        private static readonly Dictionary<Species, int> B2W2dex = new Dictionary<Species, int>() {
      {Species.Victini, 0},
      {Species.Snivy, 1},
      {Species.Servine, 2},
      {Species.Serperior, 3},
      ...
      {Species.Darmanitan, 103},
      {Species.Basculin, 104},
      ...
      {Species.Deerling, 159},
      {Species.Sawsbuck, 160},
      {Species.Foongus, 161},
      {Species.Amoonguss, 162},
      {Species.Castform, 163},
      ...
      {Species.Tornadus, 198},
      {Species.Thundurus, 199},
      {Species.Landorus, 200},
      {Species.Skorupi, 201},
      {Species.Drapion, 202},
