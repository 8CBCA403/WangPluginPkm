...
namespace WangPlugin.SortBase
{
    class Gen6_Kalos : SortingBase
    {
      ...
      {Species.Espurr, 114},
      {Species.Meowstic, 115},
      {Species.Kecleon, 116},
      {Species.Honedge, 117},
      {Species.Doublade, 118},
      {Species.Aegislash, 119},
      ...
      {Species.Moltres, 153},
        ...
        private static readonly Dictionary<Species, int> MountainKalosDex = new Dictionary<Species, int>() {
      {Species.Diglett, 1},
      {Species.Dugtrio, 2},
      {Species.Trapinch, 3},
      {Species.Vibrava, 4},
      ...
      {Species.Pumpkaboo, 63},
      {Species.Gourgeist, 64},
      {Species.Litwick, 65},
      {Species.Lampent, 66},
