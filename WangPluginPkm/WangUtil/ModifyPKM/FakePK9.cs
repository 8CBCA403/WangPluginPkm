...
{
    public class FakePK9
    {
        public byte[] Data;

        public uint seed=0;
        public FakePK9(byte[] data) => Data = data;
        public FakePK9() : this((byte[])Blank.Clone()) { }
        ...
        {   
            get => Data[0x125] >> 7; 
            set => Data[0x125] = (byte)((Data[0x125] & ~0x80) | (value << 7)); 
        }
        public  int Met_Year { get => Data[0x11C]; set => Data[0x11C] = (byte)value; }
        public  int Met_Month { get => Data[0x11D]; set => Data[0x11D] = (byte)value; }
        public  int Met_Day { get => Data[0x11E]; set => Data[0x11E] = (byte)value; }
