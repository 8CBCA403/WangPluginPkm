...
/* Unmerged change from project 'WangPluginPkm (net6.0-windows)'
Before:
#nullable enable
After:
using WangPluginPkm;
...
*/
#nullable enable
namespace WangPluginPkm.WangUtil.TeraRaid
{
...

    {
        ...
        public static List<string> GetAvailableSpecies(SAV9SV sav, int stars)
        {
            List<string> list = new();
            var game = (GameVersion)sav.Game;

            var encounters = EncounterRaid9.GetEncounters(EncounterTera9.GetArray(Properties.Resources.encounter_gem_paldea));
        ...
        public static EncounterRaid9? GetTeraEncounter(uint seed, GameVersion G, int stars, EncounterRaid9[] encounters)
        {
            var game = G;
            var xoro = new Xoroshiro128Plus(seed);
        ...
        public static TeraDetails CalcRNG(uint seed, int tid, int sid, EncounterRaid9 encounter, uint calc = 0)
        {
            ...
            {
                GenderRatio = GetGender(encounter, false),
